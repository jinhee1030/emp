...
function getDept(pageNum){
    $.ajax({
        url: 'http://192.168.0.33:8080/api/em1/dept?page='+pageNum,
        type : 'GET',
        dataType : 'json',
...
function setDept() {
    ...
    $.ajax({
        url : 'http://192.168.0.33:8080/api/em1/dept',
        type : 'POST',
...
function getDeptByDeptno(deptno){
    $.ajax({
        url: 'http://192.168.0.33:8080/api/em1/dept/deptno/'+deptno,
        type : 'GET',
        dataType : 'json',
        success : function(response){
            console.log(response);
