...
function getStatistics(){
    $.ajax({
        url: 'http://192.168.0.33:8080/api/em1/emp/statistics',
        type : 'GET',
        dataType : 'json',
...
function setEmp(){
    ...
    $.ajax({
        url: 'http://192.168.0.33:8080/api/em1/emp',
        type : 'POST',
...
function getEmp(pageNum){
    $.ajax({
        url: 'http://192.168.0.33:8080/api/em1/emp?page='+pageNum,
        type : 'GET',
        dataType : 'json',
        success : function(response){
            $('#empData').empty();
...
function getEmpByEmpno(empno){
    ...
    $.ajax({
        url: 'http://192.168.0.33:8080/api/em1/emp/empno/'+empno,
        type : 'GET',
        dataType : 'json',
        success : function(response){
            console.log(response);
...
function downloadExcelFile(){
    ...
    location.href = 'http://192.168.0.33:8080/excel/download';
}
